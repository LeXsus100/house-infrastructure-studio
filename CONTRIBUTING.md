...
- Security problems belong in GitHub private vulnerability reporting, as described in [SECURITY.md](SECURITY.md).
...
7. Run `npm test`, `npm run build`, and `npm audit`.
8. Open a pull request describing the behavior, validation performed, and known limitations.
